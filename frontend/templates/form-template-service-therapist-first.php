<?php
/**
 * Frontend booking form template - Service & Therapist First Flow
...
// Form classes
$form_classes = array('kab-booking-form', 'kab-service-therapist-first');
...
<div class="<?php echo esc_attr(implode(' ', $form_classes)); ?>" 
    ...
    <div class="kab-form-steps">
        <!-- Step 0: Service Selection (Hidden - always pre-selected) -->
                ...
                <div class="kab-details-container">
                    ...
                    <div class="kab-personal-details">
                        <div class="kab-form-group">
                            <label for="kab-first-name-stf"><?php _e('Fornavnet ditt', 'konfidens-appointment-booking'); ?></label>
                            <input type="text" id="kab-first-name-stf" name="first_name" required placeholder="<?php _e('Fornavnet ditt', 'konfidens-appointment-booking'); ?>">
                        </div>
                        
                        <div class="kab-form-group">
                            <label for="kab-email-stf"><?php _e('Din e-post', 'konfidens-appointment-booking'); ?></label>
                            <input type="email" id="kab-email-stf" name="email" required placeholder="<?php _e('Din e-post', 'konfidens-appointment-booking'); ?>">
                        </div>
                        
                        <div class="kab-form-group">
                            <label for="kab-phone-stf"><?php _e('Telefonnummeret ditt', 'konfidens-appointment-booking'); ?></label>
                            <input type="tel" id="kab-phone-stf" name="phone" required placeholder="<?php _e('Telefonnummeret ditt', 'konfidens-appointment-booking'); ?>">
                        </div>
                        
                        <div class="kab-form-group kab-checkbox-group">
                            <input type="checkbox" id="kab-terms-stf" name="terms" required>
                            <label for="kab-terms-stf"><?php _e('Klikk & samtykk til våre', 'konfidens-appointment-booking'); ?> <a href="#" class="kab-terms-link"><?php _e('handelsbetingelser', 'konfidens-appointment-booking'); ?></a> <?php _e('for å fullføre bestilling.', 'konfidens-appointment-booking'); ?></label>
                        </div>
